...
define clickhouse::server::user (
  ...
  Optional[Integer[0,1]] $named_collection_control    = undef,
  Optional[Integer[0,1]] $show_named_collections      = undef,
  Optional[Integer[0,1]] $show_named_collections_secrets = undef,
  ...
  file { "${users_dir}/${title}.xml":
    ...
    content => epp("${module_name}/user.xml.epp", {
        ...
        'named_collection_control'       => $named_collection_control,
        'show_named_collections'         => $show_named_collections,
        'show_named_collections_secrets' => $show_named_collections_secrets,
        'grants'                         => $grants,
    }),
  }
}
